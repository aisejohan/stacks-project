...
$\mathcal{F}'$ which pull back to $\id_\mathcal{F}$ is canonically
...
$\mathcal{C}$ (with $f_1 = f_2 = \id$ on underlying topoi)
...
of sheaves on a site $\mathcal{C}$ (with $f_1 = f_2 = \id$
...
(d_L^{n + 1} \otimes \id_I) \circ h^n + h^{n + 1} \circ d_K^n +
(\alpha^{n + 2} \otimes \id_I) \circ \omega^n_K
$$
...
$$
\omega^n = (d_K^{n + 1} \otimes \id_I) \circ g^n +
g^{n + 1} \circ d_K^n
$$
...
$$
\xymatrix{
K \otimes_R^\mathbf{L} S \ar[d] \ar[rr]_-{\omega(K) \otimes \id} & &
...
$(d')^n_K \otimes \id_{S'}$ for the construction of
...
then $H^i(\alpha \otimes_\mathcal{O}^\mathbf{L} \id_\mathcal{F})$
...
$H^i(\alpha \otimes_\mathcal{O}^\mathbf{L} \id_\mathcal{F})$
is an isomorphism for $i > n$ and surjective for $i = n$.
...
$H^n(\alpha \otimes_\mathcal{O}^\mathbf{L} \id_\mathcal{F})$
is an isomorphism.
\end{proof}
...
and that
$\beta = \delta \otimes_{\mathcal{O}_0}^\mathbf{L} \id_\mathcal{I}$
as maps in $D(\mathcal{O}_0)$. This is true because
$\beta =
(\alpha \otimes \id_\mathcal{I})
\circ
(\delta \otimes \id_\mathcal{I})$.
...
with $\alpha_0 = \alpha \otimes_\mathcal{O}^\mathbf{L} \id$.
\end{lemma}
...
in $D(\mathcal{O})$ with
$\varphi \otimes_\mathcal{O} \id_{\mathcal{O}_0} = \text{id}$.
This is the same thing as saying that
$$
K \xrightarrow{\varphi - \id} K \to
