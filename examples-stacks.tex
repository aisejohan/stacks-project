...
$$
F_p(U, x) =
(U, \pi \circ x, G \times_{B, \pi \circ x} U, a \circ (\id_G \times x))
$$
This makes sense because the diagram
$$
\xymatrix{
G \times_{B, \pi \circ x} U \ar[d] \ar[r]_{\id_G \times x} &
