...
one element, namely
$t_{G/U}(eU) = F(\id_{G/U})(\gamma_U) = \gamma_U$.
...
if $g = \id_X$ by (\ref{item-one-element}).
...
\sigma \bmod \mathfrak q = \id_{\kappa(\mathfrak q)}\}
$$
is equal to
$$
I_{\mathfrak q'} = \{\sigma \in G \mid
...
\text{ and } \sigma \bmod \mathfrak q = \id_\mathfrak q\}
$$
...
g \bmod \mathfrak m_y = \id_{\kappa(y)}\}$ is trivial.
\end{enumerate}
\end{lemma}
