...
\end{matrix}
$$
It is clear that always $\sigma_0 = \id$ and $\sigma_p = \sigma$.
...
\begin{equation}
\label{equation-eval}
L^\vee \otimes^\mathbf{L}_{\mathcal{O}_X} M
\longrightarrow
R\SheafHom(L, M)
\end{equation}
which induces a canonical map
$$
H^0(X, L^\vee \otimes_{\mathcal{O}_X}^\mathbf{L} M)
\longrightarrow
...
$$
K^\vee \otimes^\mathbf{L}_{\mathcal{O}_X} M = R\SheafHom(K, M)
$$
and
$$
...
$$
K^\vee \otimes^\mathbf{L}_{\mathcal{O}_X} M
\longrightarrow
R\SheafHom(K, M)
$$
...
\SheafHom_{\mathcal{O}_X}(\mathcal{E}^{-q}, \mathcal{F}^p)
$$
On the other hand, then object $K^\vee \otimes^\mathbf{L} M$
