...
$$
T \times_{f \circ v, W} V \xrightarrow{(v, \id_V)}
V \times_W V = V \amalg U
$$
The inverse image of $V$ is $T$ embedded via
$(\id_T, v) : T \to T \times_{f \circ v, W} V$.
The composition $y' = y \circ (\id_T, v) : T \to Y$
...
applying Lemma \ref{lemma-morphism-good-diagram} to $\id_X$
(in two directions)
