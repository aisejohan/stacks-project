...
\begin{proof}
Use Lemma \ref{lemma-check-rank-on-affines},
...
$A$-algebra. By More on Algebra, Lemma
\ref{more-algebra-lemma-relative-regular-element} we can find
a cocartesian diagram
$$
\xymatrix{
B_1 \ar[r] & B \\
...
$$
where $A_1$ and $B_1$ are finite type $\mathbf{Z}$-algebras
and a nonzerodivisor $h_1 \in B_1$ mapping to $h$ such that
$B_1/h_1B_1$ is $A_1$-flat.
...
\begin{enumerate}
\item If $Z_s \subset X_s$ is an effective Cartier divisor
...
$B/(f_1, \ldots, f_r)B$ is a flat $A$-algebra. By
More on Algebra, Lemma \ref{more-algebra-lemma-relative-H1-regular}
we can find a cocartesian diagram
$$
\xymatrix{
B_1 \ar[r] & B \\
A_1 \ar[u] \ar[r] & A \ar[u]
...
$$
where $A_1$ and $B_1$ are finite type $\mathbf{Z}$-algebras
and a $H_1$-regular sequence $f_{1, 1} \ldots f_{1, r} \in B_1$
mapping to $f_1, \ldots, f_r$ such that
$B_1/(f_{1, 1}, \ldots, f_{1, r})$ is $A_1$-flat.
...
\medskip\noindent
In the Noetherian case, we may use Lemma \ref{lemma-extend-invertible-module}
