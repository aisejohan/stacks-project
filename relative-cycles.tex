...
Let $f : X \to S$ be a morphism of finite presentation where $S$
is a quasi-compact and quasi-separated scheme. Let $r \geq 0$ and
let $\alpha$ and $\beta$ be families of $r$-cycles on fibres of $X/S$.
If $\alpha$ and $\beta$ satisfy the equivalent conditions (1) and (2)
of Lemma \ref{lemma-relative-r-cycle-general}, then so does $\alpha + \beta$.
\end{lemma}
