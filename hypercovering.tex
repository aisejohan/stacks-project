...
$K \to \Hom(C[k], Y)$ corresponding to $\id : K_k = Y \to Y$.
...
\xymatrix{
L_k \ar[r] \ar[d] &
\prod_{\alpha : [k] \to [k]} Z \ar[r]^-{\text{pr}_{\id_{[k]}}} \ar[d] &
Z \ar[d] \\
K_k \ar[r] &
\prod_{\alpha : [k] \to [k]} Y \ar[r]^-{\text{pr}_{\id_{[k]}}} &
Y
}
$$
...
a \circ (c \times \id_{\partial \Delta[k]})$.
...
nondegenerate, then $m = m_0$ and $\psi = \id_{[m]}$.},
