...
corresponding to $\varphi$ via $\id_{\mathfrak a}$ to the
...
to $\varphi(1 \cdot \id_X)$ in the right hand side. We can use these
...
as $\alpha^{pp} = \id$ and $t^p$ is injective.
