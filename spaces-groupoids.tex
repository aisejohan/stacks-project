...
$$
\xymatrix{
G \times_B X \ar[r]_-{\id \times f} \ar[d]_a &
G \times_B Y \ar[d]^a \\
X \ar[r]^f & Y
}
$$
...
if $\psi = (\phi, U, V)$ and
equal to $\id : (\mathcal{F}_i|_{U'})|_U \to \mathcal{F}_i|_U$
...
\ruppertwocell^{\pi \circ s \circ \text{pr}_1 = \pi \circ s \circ c}{\ \ \ \ \ \ \alpha \star \id_{\text{pr}_1}}
\ar[r]_(.3){\pi \circ t \circ \text{pr}_1 = \pi \circ s \circ \text{pr}_0}
\rlowertwocell_{\pi \circ t \circ \text{pr}_0 = \pi \circ t \circ c}{\ \ \ \ \ \ \alpha \star \id_{\text{pr}_0}}
&
[U/R]
}
$$
is the $2$-morphism $\alpha \star \id_c$. In a formula
$\alpha \star \id_c =
(\alpha \star \id_{\text{pr}_0})
\circ
(\alpha \star \id_{\text{pr}_1})
$.
\end{lemma}
...
\begin{enumerate}
\item The formula
$\alpha \star \id_c = (\alpha \star \text{id}_{\text{pr}_0}) \circ
(\alpha \star \id_{\text{pr}_1})$ only makes sense if you realize
...
\beta \star \id_c
=
(\beta \star \id_{\text{pr}_0})
\circ
(\beta \star \id_{\text{pr}_1})
$$
...
$s' \circ r'_i = \id_{U'} \circ g'_i$. Picture
$$
\xymatrix{
...
$(U, U, \id, \text{id}, \text{id})$ via $s : R \to U$.
