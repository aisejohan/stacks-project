...
$(\id_\mathcal{F}, \text{id}_\mathcal{G})$
...
(applied to $\id : T \to T$ and $\mathcal{O}_T$ and
...
$\Gamma_f = (\id, f) : Z_T \to Z_T \times_T X_T = (Z \times_B X)_T$.
...
$$
\xymatrix{
\mathit{Isom}_S(X, Y) \ar[r] \ar[d] & S \ar[d]_{(\id, \text{id})} \\
