...
$\id_Y : Y \to Y$ is a smooth morphism, and $h_i$ is as in part (3) of
...
$$
\xymatrix{
V \times_X Y \ar[r]_{\varphi} \ar[d]_{f \times \id_Y} &
Y \times_X V \ar[d]^{\id_Y \times f} \\
...
$$
\xymatrix{
V_i \times_X X_j \ar[r]_{\varphi_{ij}} \ar[d]_{\psi_i \times \id} &
X_i \times_X V_j \ar[d]^{\id \times \psi_j} \\
...
{\it trivial descent datum} of $U$ relative to $\id : X \to X$, namely
...
$$
V \times_X Y \xrightarrow{\psi \times \id_Y}
Y \times_X U \times_S Y =
Y \times_X Y \times_X U
\xrightarrow{\id_Y \times \psi^{-1}}
Y \times_X V
$$
