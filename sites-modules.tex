...
Let $(\mathcal{C}, \mathcal{O})$ be a ringed site.
Let $p$ be a point of $\mathcal{C}$. Let $U$ be an object of $\mathcal{C}$.
For $\mathcal{F}$ in $\textit{Mod}(\mathcal{O})$ the adjunction mapping
$j_{U!}j_U^{-1}\mathcal{F} \to \mathcal{F}$ induces the ``sum'' map
$$
...
\begin{proof}
By Lemma \ref{lemma-stalk-j-shriek} and
...
description of the adjunction between $j_{U!}$ and restriction to $U$
in the proof of Lemma \ref{lemma-extension-by-zero} and the explicit
description of the equality of stalks $(j_U^{-1}\mathcal{F})_q = \mathcal{F}_p$
in the proof of Sites, Lemma \ref{sites-lemma-point-functor}.
Details omitted.
\end{proof}
